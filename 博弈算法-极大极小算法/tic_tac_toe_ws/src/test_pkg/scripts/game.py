...
class TicTacToeMasterNode:
    ...
    def init_ros(self):
        ...
        self.centers_pub = rospy.Publisher("/mubiaopoint", Int32MultiArray, queue_size=1)
        rospy.loginfo("发布目标数据......")
        self.centers_pub1 = rospy.Publisher("/target_point", Int32MultiArray, queue_size=1)
